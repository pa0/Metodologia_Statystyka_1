...
* The null hypothesis of row-column independence: $$\frac{O_{ij}}{O_{\cdot\cdot}} = \frac{O_{i\cdot} O_{\cdot j}}{O_{\cdot\cdot}}$$
* is equivalent to the hypothesis of homogeneity of the rows: $$\frac{O_{1j}}{O_{1\cdot}} = \frac{O_{2j}}{O_{2\cdot}} = \dots = \frac{O_{Ij}}{O_{I\cdot}}$$
* Each row of $O$ follows a multinomial distribution
* Under homogeneity assumption, this distribution is common to all of the rows
* Maximum likelihood estimates of probability vector is equal to centroid $c$
