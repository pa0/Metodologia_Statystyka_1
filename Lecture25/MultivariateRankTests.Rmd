...
* The sample halfspace depth of $x$ is the minimum fraction of data points in any closed halfspace containing $x$
...
$$Q(F_{n1},G_{n2}) = \frac{1}{n_1 n_2} \sum_{j=1}^{n_2} \sum_{i=1}^{n_1} I(D(X_i,F_{n_1}) \le D(Y_j,F_{n_1}))$$
...
* Computation time is polynomial in $n$ but exponential in $d$ (exception of Mahalanobis depth)
