...
* Cell entires are number of deaths per 1000 live births
```{r}
...
* Second iteration: Add row effects to top margin and subtract from residuals
```{r echo=TRUE}
...
* Second iteratino: Add column effects to left margin and subtract from residuals
```{r echo=TRUE}
colMedian = apply(df[2:5,],2,median); colMedian
df[1,] = df[1,]+colMedian
df[2:5,] = sweep(df[2:5,],2,colMedian); df
...
* http://mgimond.github.io/ES218/Week11a.html
