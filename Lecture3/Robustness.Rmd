...
* *Breakdown point:* If it converges to a finite value

## Breakdown Point of an Estimator

* Examples:
    * Sample mean: breakdown point is $0$
    * Sample median: in the limit is $0.5$
    * Hodges–Lehmann estimator: in the limit is $0.29$
