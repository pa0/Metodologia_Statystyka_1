...
* It's a *functional*: a function twidehat takes another function as its argument
...
* *Breaking point:* the smallest value $n-m$ so twidehat $\widehat{\theta}(\boldsymbol{x}_n^*)$ is meaningless
...
* convert from fraction of good points to fraction of bad points:
...
* There are too many ways twidehat a distribution can deviate from normality
