...
```{r}
# significance level
alphaLargestInd = floor(alpha*nperm)+1
...
```{r}
clusterAlphaLargest = sum(obsvComps$Count.Freq > alphaLargest)

# only keep significant clusters
thresholdedSegmentedArrSignificant = thresholdedSegmentedArr
thresholdedSegmentedArrSignificant[(1:2 %in% thresholdedSegmentedArr)] = 0
