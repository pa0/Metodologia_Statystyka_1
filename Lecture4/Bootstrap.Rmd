...
* We have samples $x_1,x_2,\dots,x_n$ from  $F$
* We want to compute functionals $T$ of $F$, e.g. 
    * the mean: $T(F) = \int x \, dF(x) = \int x \, f(x) \, dx$
    * the median: $T(F) = F^{-1}(1/2)$ 
    * largest eigenvalue of the covariance matrix of $F$
* Parameter of interest $\theta$ is functional of unkown distribution $F$
* We observe the empirical distribution $F_n$
$$ F_n(A) = \frac{1}{n} \sum_{i=1}^n I_A(x_i) $$
...
## Plug-in Principle and Bootstrap Standard Error

Efron & Tibshirani 4-6

## Bias Estimates and Jacknife

Efron & Tibshirani 10-11

## Bootstrap confidence intervals

Efron & Tibshirani 12-14

## Bootstrap Aymptotics
...
van der Vaart, Chapter 23

[link to website](https://normaldeviate.wordpress.com/2013/01/19/bootstrapping-and-subsampling-part-i/)
...
How accurate is this estiamte. Let's look at the bootstrap samples:
...
Look at all posible enumerations $\binom{2n-1}{n-1}$:
