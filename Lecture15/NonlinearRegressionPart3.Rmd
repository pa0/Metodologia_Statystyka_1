...
* For now, suppose that $\sigma$ is known, then
$$\operatorname{P}(\bar{r} \notin \text{ for some } x \in [a,b]) = \operatorname{P}\left(\underset{x \in [a,b]}{\max} \frac{|\widehat{r}(x)-\bar{r}|}{\sigma\|l(x)\|} > c \right)$$
...
TODO: Efron and Tibshirani (1994), page 70, 111
