...
* The USVT estimator is a consistent estimator (as the nubmer of node goes to infintiy) of the probability matrix $M$ (Chatterjee 2012)
* An alternative estiamtor is the the histogram estimator proposed by Chan and Airoldi (2014)
...
1. **Sorting**: Rearrange graph so that the empirical degrees (number of incomding and outgoing edges per node) are monotonically increasing
...
* Ssymmetric binary graph consisting of $1.8 \times 104$ nodes and $3.9 \times 105$ edges
...
* Who-trust-whom online social network of a a general consumer review site Epinions.com
* Members of the site can decide whether to "trust" each other
* Unsymmetrical binary graph consisting of $7.5 \times 104$ nodes and $5.1 \times 105$ edges
...
* Therefore every graphon can be approximated by a stochastic blockmodel
