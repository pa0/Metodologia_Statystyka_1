...
* Degree of a node: number of incomding and outgoing edges
...
* The USVT estimator is a consistent estimator (as the nubmer of nodes goes to infintiy) of the probability matrix $M$ (Chatterjee 2012)
