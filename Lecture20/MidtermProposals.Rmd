...
* Using the common significance level $\alpha = 0.05$, we expect to see 6,500 false discoveries
...
* For example, in comparing six or ten different treatments, it is very reasonable to control the probability
of returning even one ineffective treatment
