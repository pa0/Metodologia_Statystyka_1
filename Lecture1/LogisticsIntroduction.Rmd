...
Let's look at an even simpler example of only three differences, with 8 possible outcomes:

```{r message=FALSE}
library(R.utils); data.frame(code=intToBin(0:7))
```

* Rank is position in the binary string
* 0 is negative difference
* 1 is positive difference
