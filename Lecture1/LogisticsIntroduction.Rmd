...
This is the command for installing the pacakge ``bootstrap``:
...
* You saw an example using the ranks of differences instead the acutal differences for hypothesis testing
