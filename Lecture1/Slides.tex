...
\item Blackboard Derivation of the Distribution of $W^+$ under $H_0$: \linebreak
Comment 5 on P. 46 in Hollander, Myles, and Wolfe \linebreak
\end{itemize}
...
\begin{frame}
\frametitle{Summary and Next Class}
