...
From the textbook Nonparametric Statistical Methods by Hollander, Wolfe, and Chicken [(Stanford link)](http://site.ebrary.com/lib/stanford/reader.action?docID=10799793) textbook (Problem 7, p. 654):  
...
(a) Implement USVT yourself (hint: you can rewrite [this](https://github.com/airoldilab/SAS/blob/master/usvt.m) Matlab script in R (use $\nu = 0.01$).
(b) Sort the empirical degrees and rearrange the nodes of the graph. Plot reconstructed matrix with rearranged columns and rows.
