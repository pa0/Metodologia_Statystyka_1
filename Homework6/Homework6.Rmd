...
Value Thresholding (USVT) as discussed in class [(slides)](http://christofseiler.github.io/stats205/Lecture23/GraphLimits.pdf).

(a) Implement USVT yourself or rewrite it from [this](https://github.com/airoldilab/SAS/blob/master/usvt.m) Matlab script in R (use $\nu = 0.01$).
