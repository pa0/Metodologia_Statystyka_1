...
matches = apply(permutations,2,function(i) sum(truth[i] == truth))
table(matches)/nSim
```
...
* In chapter 3 of Fisher's book, he then introduced the first nonparametric test developed and is widely used; indeed in their analysis of paired experimental designs
