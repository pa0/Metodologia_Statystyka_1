...
* Often, we want to predict random variable $Y$ from $x$ and we treat $x$ as nonstochstic
...
* two pairs of random variables $(X_1,Y_1)$ and $(X_2,Y_2)$ be independent random vectors with the same distribution as $(X,Y)$
