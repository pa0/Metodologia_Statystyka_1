...
* In the other direction:
    * de Finetti showed in 1931 that all infinite exchangeable binary sequences are i.i.d. Bernoulli with beta prior $\mathcal{B}(b/a,w/a)$ on the success paramter
    * Hewitt and Savage (1955) generalized de Finetti's result
