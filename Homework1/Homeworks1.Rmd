...
Approximate the power of a $t$-test of $H0: \mu = 0$ versus $H_A: \mu > 0$ when the true mean is $\mu = 0.5$. Assume a random sample of size $n = 25$ from a normal distribution with $\sigma = 1$. Assume $\alpha = 0.05$.
