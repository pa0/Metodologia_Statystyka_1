...
Correspondence analysis is useful for text analysis. For instance, to compare text from two different authors in terms of the frequency of words used in their texts. The idea: Make a contingency table where rows are words and columns are books. Use association mosaic plots, and correspondence analysis, to determine what words contributed heavily to the inhomogeneity. 
