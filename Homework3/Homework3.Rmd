...
Correspondence analysis is useful for text analysis. For instance, to compare text from different authors in terms of the common word frequency. The idea: Make a contingency table where rows are words and columns are books. Use association mosaic plots, and correspondence analysis, to determine what words contributed heavily to the inhomogeneity. 
