...
Correspondence analysis is useful for text analysis. For instance, to compare text from different authors in terms of the common word frequency. The idea: Make a contingency table where rows are books from different authors and columns are words. Use association plots, mosaic plots, and correspondence analysis, to determine if there are any words that contribute heavily to inhomogeneity among books.

Perform this type of analysis on the following four books form the ``languageR`` package:
...
*Hint:* Use package *vcd* and *ca*. Limit your analysis to words that occur frequently in all books.
...
This homework is due on Saturday, April 25th at 1:30 pm.
